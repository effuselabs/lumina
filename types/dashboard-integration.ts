...
import { AppointmentWithRelations } from './database'
...
export interface ConflictInfo {
    type: 'overlap' | 'staff_unavailable' | 'business_closed' | 'service_conflict'
...
export interface RealTimeUpdate {
    type: 'appointment_created' | 'appointment_updated' | 'appointment_cancelled' | 'appointment_rescheduled' | 'status_changed'
