...
test.describe('Visual Regression Tests', () => {
            ...
            breakpoints.forEach(breakpoint => {
                test.describe(`${breakpoint.name} breakpoint`, () => {
                    ...
                    test('StatCard component variants and states', async ({ page }) => {
                        ...
                        // Test loading state
                        const loadingCard = page.locator('[data-testid="stat-card-loading"]');
                    ...
                    test('Form components', async ({ page }) => {
                        ...
                        const selectElement = page.locator('[data-testid="select-default"]');
                        if (await selectElement.count() > 0) {
                            ...
                            await expect(page.locator('[data-testid="select-content"]')).toHaveScreenshot(
                                `select-open-${theme}-${breakpoint.name}.png`
                            );
                        }

                        // Test textarea
                        const textareaElement = page.locator('[data-testid="textarea-default"]');
                    ...
                    test('Page layout components', async ({ page }) => {
                        ...
                        const pageHeader = page.locator('[data-testid="page-header-default"]');
                        ...
                        const compactHeader = page.locator('[data-testid="page-header-compact"]');
    ...
    test.describe('Theme switching animation', () => {
        test('Theme transition is smooth', async ({ page }) => {
            ...
            await expect(page.locator('body')).toHaveScreenshot('theme-before-transition.png');
            ...
            await expect(page.locator('body')).toHaveScreenshot('theme-after-transition.png');
        });
    });
    ...
    test.describe('Component composition', () => {
        test('Complex component layouts', async ({ page }) => {
            ...
            await expect(page.locator('[data-testid="dashboard-layout"]')).toHaveScreenshot(
                'dashboard-layout-light-desktop.png'
            );
            ...
            await expect(page.locator('[data-testid="dashboard-layout"]')).toHaveScreenshot(
                'dashboard-layout-dark-desktop.png'
            );
        });
    });
});