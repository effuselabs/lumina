...
test.describe('Public Booking - Desktop', () => {
  ...
  test('should complete full booking workflow on desktop', async ({ page }) => {
    ...
    await expect(
      page.getByText('Professional haircut and styling')
    ).toBeVisible();
    ...
    await page
      .getByLabel('Special requests or notes')
      .fill('Please use organic products');
...
test.describe('Public Booking - Mobile', () => {
  ...
  test('should complete booking workflow on mobile with touch interactions', async ({
    page,
  }) => {
    await page.goto(BOOKING_URL);
  ...
  test('should handle mobile viewport changes and orientation', async ({
    page,
  }) => {
    await page.goto(BOOKING_URL);
  ...
  test('should handle mobile-specific error states', async ({ page }) => {
    ...
    await expect(
      page.getByText('Unable to load booking information')
    ).toBeVisible();
    await expect(
