...
export default function EmploymentDemoPage() {
  const [selectedType, setSelectedType] =
    useState<EmploymentType>('COMMISSION');
  const [previewConfig, setPreviewConfig] = useState<
    Partial<EmploymentConfiguration>
  >({
  ...
  const handleConfigurationSubmit = async (
    _config: EmploymentConfiguration
  ) => {
    setIsLoading(true);
    // Configuration submitted - would normally send to API
    // Simulate API call
  ...
  const handleUpdateEmployment = async (
    ...
    // Update employment for staff - would normally send to API
    // Simulate API call
    await new Promise(resolve => setTimeout(resolve, 1000));
    alert('Employment updated successfully!');
  };

  const handleTransitionEmployment = async (
    _transition: unknown,
    _config: unknown
  ) => {
    // Transition employment - would normally send to API
    // Simulate API call
  ...
  return (
    <div className="container mx-auto space-y-8 py-8">
      <PageHeader
        title="Employment UI Components Demo"
        description="Comprehensive demonstration of hybrid employment management components"
        variant="default"
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'Employment Demo' },
        ]}
        ...
        <TabsContent value="selector" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Interactive component for selecting employment types with
        ...
        <TabsContent value="transition" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Guided workflow for changing employment types with data
                migration
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-4 text-center">
                <p className="text-sm text-muted-foreground">
                  Click the button below to open the employment transition
                  dialog
                </p>
        ...
        <TabsContent value="management" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Full-featured employment management interface with all
        ...
        <TabsContent value="validation" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Examples of validation messages and help text for complex
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="rounded border border-red-200 bg-red-50 p-3">
                      <p className="text-red-700">
                        ❌ Commission rate must be between 10% and 90%
                      </p>
                    </div>
                    <div className="rounded border border-green-200 bg-green-50 p-3">
                      <p className="text-green-700">
                        ✅ Commission rate of 60% is valid
                      </p>
                    </div>
                    <div className="rounded border border-blue-200 bg-blue-50 p-3">
                      <p className="text-blue-700">
                        💡 Base salary is optional but recommended for income
                        stability
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="rounded border border-red-200 bg-red-50 p-3">
                      <p className="text-red-700">
                        ❌ Hybrid model requires both commission and rental
                        components
                      </p>
                    </div>
                    <div className="rounded border border-orange-200 bg-orange-50 p-3">
                      <p className="text-orange-700">
                        ⚠️ Commission rate should be lower in hybrid model
                        (typically 20-50%)
                      </p>
                    </div>
                    <div className="rounded border border-green-200 bg-green-50 p-3">
                      <p className="text-green-700">
                        ✅ Hybrid configuration is balanced and fair
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <Card className="border-blue-200">
                    ...
                    <CardContent className="text-xs text-blue-600">
                      <p>
                        ...
                        Higher rates motivate performance but reduce business
                        margins.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-green-200">
                    ...
                    <CardContent className="text-xs text-green-600">
                      <p>
                        Fixed fee charged per period. Provides predictable
                        income for business but creates fixed costs for staff.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-purple-200">
                    ...
                    <CardContent className="text-xs text-purple-600">
                      <p>
                        Guaranteed minimum income regardless of performance.
                        Provides security but increases fixed costs.
                      </p>
                    </CardContent>
                  </Card>
                </div>
