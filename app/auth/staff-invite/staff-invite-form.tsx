        ...
        return (
            <Card>
                <CardContent className="text-center py-12">
                    ...
                    <p className="text-gray-600">This invitation may have expired or been used already.</p>
                </CardContent>
            </Card>
        );
    }
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="font-semibold">{invitation.staffData.displayName}</p>
                            {invitation.staffData.title && (
                                <p className="text-sm text-gray-600">{invitation.staffData.title}</p>
                            )}
                        </div>
                        <div>
                            <h4 className="font-medium text-sm text-gray-700">Employment</h4>
                            <Badge className={getEmploymentBadgeColor(invitation.staffData.employmentType)}>
