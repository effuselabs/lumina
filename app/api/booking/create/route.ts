...
export async function POST(request: NextRequest) {
    try {
        ...
        const { businessId, serviceId, staffId, startTime, endTime, client, notes } = validation.data
        ...
        try {
            const emailResult = await emailService.sendBookingConfirmation({
                ...
                staffName: appointment.staff.displayName || appointment.staff.user.name || '',
                appointmentDate: format(new Date(appointment.startTime), 'EEEE, MMMM d, yyyy'),
