...
export async function POST(request: NextRequest) {
    try {
        ...
        const { appointmentId, amount, description } = createPaymentSchema.parse(body);
        ...
        const paymentIntent = await createPaymentIntent({
            ...
            description: description || `Payment for appointment with ${appointment.staff.displayName}`,
        });
