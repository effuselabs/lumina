...
async function handlePaymentSucceeded(event: Stripe.Event) {
  ...
  try {
    ...
    console.error(
      `Error processing payment success: ${paymentIntent.id}`,
      error
    );
  }
}
...
async function handlePaymentFailed(event: Stripe.Event) {
  ...
  try {
    ...
    console.error(
      `Error processing payment failure: ${paymentIntent.id}`,
      error
    );
  }
}
...
async function handlePaymentCanceled(event: Stripe.Event) {
  ...
  try {
    ...
    console.log(
      `Successfully processed payment cancellation: ${paymentIntent.id}`
    );
  } catch (error) {
    console.error(
      `Error processing payment cancellation: ${paymentIntent.id}`,
      error
    );
  }
}
...
async function handlePaymentRequiresAction(event: Stripe.Event) {
  ...
  try {
    ...
    console.log(
      `Successfully processed payment requires action: ${paymentIntent.id}`
    );
  } catch (error) {
    console.error(
      `Error processing payment requires action: ${paymentIntent.id}`,
      error
    );
  }
}
