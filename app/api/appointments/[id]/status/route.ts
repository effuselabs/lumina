...
export async function PUT(
    ...
    try {
        ...
        const updatedAppointment = await appointmentService.getAppointmentById(params.id, businessId)
...
export async function GET(
    ...
    try {
        ...
        const validTransitions = statusManager.getValidTransitions(appointment.status)
