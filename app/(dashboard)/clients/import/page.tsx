        ...
        <div className="container mx-auto px-4 py-8">
                        ...
                        {[
                            ...
                            <li key={step.id} className={`${stepIdx !== 2 ? 'pr-8 sm:pr-20' : ''} relative`}>
                                <div className="flex items-center">
                                    <div
                                        className={`flex h-8 w-8 items-center justify-center rounded-full border-2 ${currentStep === step.step
                                                ? 'border-orange-500 bg-orange-500 text-white'
                                                : stepIdx < ['upload', 'mapping', 'results'].indexOf(currentStep)
                                    ...
                                    <span
                                        className={`ml-3 text-sm font-medium ${currentStep === step.step ? 'text-orange-600' : 'text-gray-500'
                                            }`}
                                    >
                                        {step.name}
                                    </span>
            ...
            <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <div className="text-sm text-blue-700 space-y-1">
                    ...
                    <p>• Optional fields: email, phone, address, city, state, zip_code, notes</p>
