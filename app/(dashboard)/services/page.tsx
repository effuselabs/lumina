...
export default function ServicesPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useServices(businessId, filters);
        ...
        {isLoading ? (
          ...
          <EmptyServicesState
            hasFilters={Object.keys(filters).some(
              key => filters[key as keyof ServiceFilters]
            )}
            onCreateService={() => setIsCreateDialogOpen(true)}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              &quot;? This will hide the service from your booking system, but
...
function EmptyServicesState({
  ...
  onCreateService,
  onClearFilters,
}: EmptyServicesStateProps) {
  return (
    <div className="py-12 text-center">
      <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-r from-orange-100 to-orange-200">
        <svg
      ...
      {hasFilters ? (
        ...
        <>
          ...
          <p className="mb-6 text-gray-600">
            Get started by creating your first service. Services are what your
            clients book appointments for.
          </p>
          <button
            onClick={onCreateService}
            className="inline-flex items-center rounded-md border border-transparent bg-gradient-to-r from-orange-400 to-orange-500 px-4 py-2 text-sm font-medium text-white hover:from-orange-500 hover:to-orange-600"
          >
