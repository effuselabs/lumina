        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="h-4 w-full rounded bg-lumina-gold"></div>
                <div className="h-4 w-full rounded bg-lumina-coral"></div>
                <div className="h-4 w-full rounded bg-deep-teal"></div>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              >
                <span className="p-1 text-xs">--lumina-gold</span>
              </div>
              <div
                className="h-8 w-full rounded"
                style={{ backgroundColor: 'var(--lumina-coral)' }}
              >
                <span className="p-1 text-xs">--lumina-coral</span>
              </div>
              <div
                className="h-8 w-full rounded"
                style={{ backgroundColor: 'var(--deep-teal)' }}
              >
                <span className="p-1 text-xs text-white">--deep-teal</span>
              </div>
              <div
