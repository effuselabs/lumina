            ...
            <div className="mx-auto max-w-6xl space-y-12">
                ...
                <section>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                The default page header provides maximum visual hierarchy and spacing
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-2 text-sm text-color-foreground-secondary">
                                ...
                                <li>• Flexible action buttons with primary/secondary variants</li>
                ...
                <section>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                The compact page header optimizes space while maintaining usability
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-2 text-sm text-color-foreground-secondary">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-color-foreground-secondary">
                                The PageHeader component gracefully handles minimal configurations,
                                providing consistent typography and spacing even with just basic content.
                            </p>
                        </CardContent>
                    </Card>
                </section>
                ...
                <section>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-sm text-color-foreground-secondary">
                                The children prop allows you to add custom content below the main header,
                                such as status indicators, filters, or other contextual information.
                            </p>
                        </CardContent>
                    </Card>
                </section>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <h4 className="font-semibold text-sm">Desktop (Default)</h4>
                                <p className="text-sm text-color-foreground-secondary">
                                    Full horizontal layout with actions on the right side
                                </p>
                            </div>
                            <div className="space-y-2">
                                <h4 className="font-semibold text-sm">Tablet (≤768px)</h4>
                                <p className="text-sm text-color-foreground-secondary">
                                    Stacked layout with actions below the title, reduced typography scale
                                </p>
                            </div>
                            <div className="space-y-2">
                                <h4 className="font-semibold text-sm">Mobile (≤480px)</h4>
                                <p className="text-sm text-color-foreground-secondary">
                                    Further reduced spacing and typography, actions may wrap or stack
                                </p>
                            </div>
                            <div className="space-y-2">
                                <h4 className="font-semibold text-sm">Small Mobile (≤360px)</h4>
                                <p className="text-sm text-color-foreground-secondary">
