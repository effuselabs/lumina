...
export default function ButtonsPage() {
    return (
        <div className="container mx-auto py-8 space-y-8">
            <div>
                <h1 className="text-3xl font-bold mb-2">Enhanced Button Component</h1>
            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    {/* CTA Section */}
                    <div className="p-6 bg-gradient-to-r from-lumina-gold/10 to-lumina-coral/10 rounded-lg">
                        <h3 className="text-lg font-semibold mb-2">Ready to get started?</h3>
                        <p className="text-muted-foreground mb-4">
                            Join thousands of salon owners who trust Lumina to manage their business.
                        </p>
