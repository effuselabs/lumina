      ...
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Different grid layouts optimized for various content types and
              information density requirements.
            </p>
          </div>

          <div
            className={`grid-container grid-cards ${debugMode ? 'grid-debug' : ''}`}
          >
            <Card>
              <CardHeader>
              ...
              <CardContent>
                ...
                <p className="text-color-foreground-secondary mt-2 text-sm">
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Specialized grid layout optimized for metric cards and dashboard
              statistics.
            </p>
          </div>

          <div
            className={`grid-container grid-dashboard-stats ${debugMode ? 'grid-debug' : ''}`}
          >
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Demonstrates the compact grid variant with reduced spacing and
              smaller minimum widths.
            </p>
          </div>

          <div
            className={`grid-container grid-cards-compact ${debugMode ? 'grid-debug' : ''}`}
          >
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Maximum information density for data-heavy interfaces and compact
              displays.
            </p>
          </div>

          <div
            className={`grid-container grid-cards-dense ${debugMode ? 'grid-debug' : ''}`}
          >
            {sampleCards.map(card => (
              <Card key={card.id} className="p-4">
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold">{card.title}</h3>
                  <p className="text-color-foreground-secondary text-xs">
                    {card.content}
                  </p>
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Traditional fixed-column layouts that adapt responsively on
              smaller screens.
            </p>
          </div>
          ...
          <div className="space-y-8">
            {/* 2 Column Grid */}
            <div>
              <h3 className="mb-4 text-lg font-semibold">Two Column Grid</h3>
              <div
                className={`grid-container gap-lg grid-cols-2 ${debugMode ? 'grid-debug' : ''}`}
              >
                <Card>
                  <CardHeader>
                  ...
                  <CardContent>
                    <p className="text-color-foreground-secondary text-sm">
                      This demonstrates a fixed two-column layout that becomes
            ...
            {/* 3 Column Grid */}
            <div>
              <h3 className="mb-4 text-lg font-semibold">Three Column Grid</h3>
              <div
                className={`grid-container gap-lg grid-cols-3 ${debugMode ? 'grid-debug' : ''}`}
              >
        ...
        <section className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-color-foreground-secondary">
              Additional utilities for gap control, alignment, and item
              spanning.
            </p>
          </div>
          ...
          <div className="space-y-8">
            {/* Gap Utilities */}
            <div>
              <h3 className="mb-4 text-lg font-semibold">Gap Utilities</h3>
              <div className="space-y-4">
                <div>
                  ...
                  <div
                    className={`grid-container gap-sm grid-cols-3 ${debugMode ? 'grid-debug' : ''}`}
                  >
                    {[1, 2, 3].map(i => (
            ...
            {/* Column Spanning */}
            <div>
              <h3 className="mb-4 text-lg font-semibold">Column Spanning</h3>
              <div
                className={`grid-container gap-md grid-cols-4 ${debugMode ? 'grid-debug' : ''}`}
              >
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-color-foreground-secondary pl-5 text-sm">
                    Full responsive grid with auto-fit columns based on minimum
                    widths
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-color-foreground-secondary pl-5 text-sm">
                    Reduced minimum widths and gaps, maintains responsive
                    behavior
                  </p>
                </div>
              ...
              <div className="border-color-border border-t pt-4">
                <h4 className="mb-2 font-semibold">Available Grid Classes</h4>
