...
// API functions
const fetchServices = async (businessId: string, filters: ServiceFilters = {}): Promise<Service[]> => {
...
const updateService = async (serviceId: string, serviceData: UpdateServiceData): Promise<Service> => {
    const response = await fetch(`/api/services/${serviceId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
...
// Hooks
export const useServices = (businessId: string, filters: ServiceFilters = {}) => {
    return useQuery({
...
export const useCreateService = () => {
    ...
    return useMutation({
        ...
        onSuccess: (newService) => {
            ...
            queryClient.invalidateQueries({ queryKey: ['services', newService.businessId] });
...
export const useUpdateService = () => {
    ...
    return useMutation({
        ...
        onSuccess: (updatedService) => {
            ...
            // Invalidate services list
            queryClient.invalidateQueries({ queryKey: ['services', updatedService.businessId] });
