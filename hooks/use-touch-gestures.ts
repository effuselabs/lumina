...
export function useTouchGestures(options: TouchGestureOptions = {}) {
    ...
    const handleTouchMove = useCallback((event: TouchEvent) => {
        ...
        } else if (event.touches.length === 2 && initialPinchDistanceRef.current && onPinch) {
    ...
    }, [threshold, onSwipeLeft, onSwipeRight, onSwipeUp, onSwipeDown, onTap, gestureState.isLongPressing]);
