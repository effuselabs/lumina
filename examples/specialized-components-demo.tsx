        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-6 px-4">
                    <h1 className="text-4xl md:text-6xl font-bold text-color-foreground">
                        Premium Components
                    </h1>
                    <p className="text-xl text-color-foreground-secondary max-w-2xl mx-auto">
                        Showcase of specialized components with animations and premium effects
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <h3 className="text-xl font-semibold text-color-foreground">Particle Field</h3>
                            <div className="relative h-48 rounded-lg overflow-hidden border">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-lg font-medium text-color-foreground bg-white/80 dark:bg-black/80 px-4 py-2 rounded">
                                        Particle Field
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-xl font-semibold text-color-foreground">Geometric Pattern</h3>
                            <div className="relative h-48 rounded-lg overflow-hidden border">
                                <HeroBackground
