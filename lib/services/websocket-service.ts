...
export class WebSocketService {
  ...
  async broadcastToRoom(room: string, message: any): Promise<void> {
    console.warn(
      'broadcastToRoom called on client-side WebSocket service. This should be handled server-side.'
    );
  ...
  async broadcastToUser(userId: string, message: any): Promise<void> {
    console.warn(
      'broadcastToUser called on client-side WebSocket service. This should be handled server-side.'
    );
