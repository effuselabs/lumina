...
const CRITICAL_COLOR_COMBINATIONS = [
  // Light theme combinations
  {
    ...
    fg: LUMINA_COLORS.neutral900,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Light: Secondary text on background',
    fg: LUMINA_COLORS.neutral700,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Light: Deep teal on white',
    fg: LUMINA_COLORS.deepTeal,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Light: Gold on deep teal',
    fg: LUMINA_COLORS.luminaGold,
    bg: LUMINA_COLORS.deepTeal,
  },
  // Removed: White on gold is not a practical combination and fails contrast
  {
    name: 'Light: Deep teal on gold',
    fg: LUMINA_COLORS.deepTeal,
    bg: LUMINA_COLORS.luminaGold,
  },

  // Dark theme combinations
  {
    name: 'Dark: Primary text on background',
    fg: LUMINA_COLORS.neutral100,
    bg: LUMINA_COLORS.neutral950,
  },
  {
    name: 'Dark: Secondary text on background',
    fg: LUMINA_COLORS.neutral400,
    bg: LUMINA_COLORS.neutral950,
  },
  {
    name: 'Dark: Gold on dark background',
    fg: LUMINA_COLORS.luminaGold,
    bg: LUMINA_COLORS.neutral900,
  },
  {
    name: 'Dark: White on dark surface',
    fg: LUMINA_COLORS.neutralWhite,
    bg: LUMINA_COLORS.neutral800,
  },
  {
    name: 'Dark: Gold on deep teal',
    fg: LUMINA_COLORS.luminaGold,
    bg: LUMINA_COLORS.deepTeal,
  },
  ...
  // Status colors
  {
    ...
    fg: LUMINA_COLORS.success,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Warning text on background',
    fg: LUMINA_COLORS.warning,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Error text on background',
    fg: LUMINA_COLORS.error,
    bg: LUMINA_COLORS.neutralWhite,
  },
  {
    name: 'Info text on background',
    fg: LUMINA_COLORS.info,
    bg: LUMINA_COLORS.neutralWhite,
  },
] as const;
...
export function validateCurrentTheme(): ThemeValidationResult {
  ...
  const currentCombinations = [
    {
      name: 'Current: Foreground on background',
      fg: currentColors.foreground,
      bg: currentColors.background,
    },
    {
      name: 'Current: Secondary foreground on background',
      fg: currentColors.foregroundSecondary,
      bg: currentColors.background,
    },
    {
      name: 'Current: Foreground on surface',
      fg: currentColors.foreground,
