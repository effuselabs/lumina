...
export class BusinessContextSecurityService {
    ...
    async validateBusinessContext(
        ...
        try {
            ...
            const businessUser = currentUser.businesses.find(bu => bu.businessId === businessId)
    ...
    async validateResourceOwnership(
        ...
        try {
            ...
            const businessValidation = await this.validateBusinessContext(businessId, userId, undefined, metadata)
            if (!businessValidation.isValid) {
                return businessValidation
            }

            // Validate resource belongs to business
            const isValidOwnership = await this.checkResourceOwnership(resourceType, resourceId, businessId)
    ...
    async getSecurityViolations(
        ...
        try {
            ...
            return { violations: [], total: 0, summary: {} as Record<SecurityViolationType, number> }
        }
    }
    ...
    async validateClientAccess(
        ...
        return this.validateResourceOwnership('client', clientId, businessId, userId, metadata)
    }
    ...
    async validateStaffAccess(
        ...
        return this.validateResourceOwnership('staff', staffId, businessId, userId, metadata)
    }
     ...
     */
    private async triggerSecurityAlert(violation: SecurityViolation): Promise<void> {
...
export async function validateBusinessContext(
    ...
    return businessContextSecurity.validateBusinessContext(businessId, userId, requiredRoles, metadata)
}
...
export async function validateResourceOwnership(
    ...
    return businessContextSecurity.validateResourceOwnership(resourceType, resourceId, businessId, userId, metadata)
}
