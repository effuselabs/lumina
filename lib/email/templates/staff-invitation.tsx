        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              ...
              <strong>{businessName}</strong> as a staff member on Lumina.
            </Text>
            ...
            <Text style={smallText}>
              This invitation will expire on {formatDate(expiresAt)}. If you
              don't accept by then, you'll need to request a new invitation.
            </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This invitation was sent to you by {businessName}. If you weren't
              expecting this invitation, you can safely ignore this email.
            </Text>
            <Text style={footerText}>© 2024 Lumina. All rights reserved.</Text>
          </Section>
        </Container>
      </Body>
    </Html>
