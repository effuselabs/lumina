...
export function withAnalyticsTracking(
    ...
    return async (request: NextRequest): Promise<NextResponse> => {
        ...
        try {
            ...
            if (!businessId && (request.method === 'POST' || request.method === 'PUT')) {
                try {
...
export function withPublicBookingAnalytics(
    ...
    return async (request: NextRequest): Promise<NextResponse> => {
        ...
        if (!businessId) {
            console.warn('No business ID found for public booking analytics tracking');
        ...
        try {
            ...
            console.error('Failed to track public booking API performance:', trackingError);
        }
