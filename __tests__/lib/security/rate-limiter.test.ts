...
describe('InputSanitizer', () => {
    ...
    describe('Business context validation', () => {
        it('should validate business access', () => {
            ...
            const result = InputSanitizer.validateBusinessContext(businessId, userBusinessIds)
            expect(result).toBe(true)
        })
        ...
        it('should reject invalid business ID', () => {
            ...
            const result2 = InputSanitizer.validateBusinessContext(null as any, ['biz-123'])
...
describe('CSRFProtection', () => {
    describe('Token generation and validation', () => {
        ...
        it('should reject malformed tokens', () => {
            const isValid1 = CSRFProtection.validateToken('invalid-token', 'session-123')
        ...
        it('should reject expired tokens', () => {
            ...
            const hash = crypto.createHmac('sha256', process.env.CSRF_SECRET || 'default-csrf-secret')
                .update(data)
                .digest('hex')
