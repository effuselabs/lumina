...
describe('ValidationMiddleware', () => {
    const { withRateLimit, abuseDetector, InputSanitizer, CSRFProtection } = require('@/lib/security/rate-limiter')
    ...
    describe('Basic validation', () => {
        ...
        it('should validate correct data', async () => {
            ...
            const result = await ValidationMiddleware.validateRequest(req, testSchema)
    ...
    describe('CSRF validation', () => {
        ...
        it('should validate CSRF token', async () => {
            ...
            expect(result.success).toBe(true)
            expect(CSRFProtection.validateToken).toHaveBeenCalledWith('token123', 'session123')
        })
