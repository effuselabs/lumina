...
describe('AvailabilityCache', () => {
  ...
  describe('get', () => {
    ...
    it('should handle database errors gracefully', async () => {
      asMock(mockPrisma.availabilityCache.findUnique).mockRejectedValue(
  ...
  describe('set', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      asMock(mockPrisma.availabilityCache.upsert).mockRejectedValue(
        new Error('Database error')
      );
    ...
    it('should cleanup old entries when approaching limit', async () => {
      ...
      asMock(mockPrisma.availabilityCache.deleteMany).mockResolvedValue({
        count: 2,
      } as any);
      asMock(mockPrisma.availabilityCache.upsert).mockResolvedValue({} as any);
  ...
  describe('invalidate', () => {
    ...
    it('should handle database errors gracefully', async () => {
      asMock(mockPrisma.availabilityCache.deleteMany).mockRejectedValue(
        new Error('Database error')
      );

      // Should not throw error
      await expect(
        AvailabilityCache.invalidate({ businessId })
      ).resolves.toBeUndefined();
    });
  });
  ...
  describe('getCacheStats', () => {
    ...
    it('should handle database errors gracefully', async () => {
      asMock(mockPrisma.availabilityCache.count).mockRejectedValue(
        new Error('Database error')
      );
