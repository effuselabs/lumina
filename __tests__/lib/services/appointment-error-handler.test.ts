...
describe('AppointmentErrorHandler', () => {
    ...
    describe('handleDatabaseError', () => {
        it('should handle Prisma known request errors', () => {
            ...
            const result = appointmentErrorHandler.handleDatabaseError(prismaError, mockContext)
        ...
        it('should handle record not found errors', () => {
            ...
            const contextWithAppointment = { ...mockContext, appointmentId: 'apt-123' }
            const result = appointmentErrorHandler.handleDatabaseError(prismaError, contextWithAppointment)
        ...
        it('should handle generic errors', () => {
            ...
            const result = appointmentErrorHandler.handleDatabaseError(genericError, mockContext)
    ...
    describe('handleCalendarIntegrationError', () => {
        const { gracefulDegradation } = require('@/lib/services/graceful-degradation')
        ...
        it('should execute calendar operation successfully', async () => {
            ...
            const result = await appointmentErrorHandler.handleCalendarIntegrationError(
                'check_availability',
                mockContext,
                calendarOperation
            )
        ...
        it('should handle calendar operation failure with fallback', async () => {
            ...
            const calendarOperation = jest.fn().mockRejectedValue(new Error('Calendar service down'))
        ...
        it('should throw CalendarIntegrationFailureError when no fallback', async () => {
            ...
            gracefulDegradation.executeWithDegradation.mockRejectedValue(
                new CalendarIntegrationFailureError('check_availability', 'calendar_service', false)
            )
    ...
    describe('generateDetailedErrorMessage', () => {
        it('should generate detailed error message with suggestions', () => {
            ...
            const result = appointmentErrorHandler.generateDetailedErrorMessage(error, mockContext)
        ...
        it('should limit suggestions to 5 items', () => {
            ...
            const error = new AppointmentNotFoundError('apt-123', 'biz-456', manySuggestions)
    ...
    describe('error monitoring', () => {
        it('should track error statistics', () => {
            ...
            const error2 = new DatabaseConstraintViolationError('create', 'constraint', {})
...
describe('withAppointmentErrorHandling', () => {
    const { withEnhancedErrorHandling } = require('@/lib/services/enhanced-error-handler')
    ...
    it('should validate context before execution', async () => {
        ...
        await expect(
            withAppointmentErrorHandling('create_appointment', invalidContext, operation)
...
describe('withCalendarIntegrationErrorHandling', () => {
    ...
    it('should execute calendar operation successfully', async () => {
        ...
        jest.spyOn(appointmentErrorHandler, 'handleCalendarIntegrationError')
        ...
        expect(result).toBe(mockResult)
        expect(appointmentErrorHandler.handleCalendarIntegrationError).toHaveBeenCalledWith(
            'check_availability',
            mockContext,
            calendarOperation,
            undefined
    ...
    it('should execute with fallback operation', async () => {
        const mockResult = { available: false, fallback: true }
        const calendarOperation = jest.fn().mockRejectedValue(new Error('Service down'))
        const fallbackOperation = jest.fn().mockResolvedValue(mockResult)
