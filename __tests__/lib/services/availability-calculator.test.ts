...
const mockConflictEngine = ConflictDetectionEngine as jest.Mocked<
...
describe('AvailabilityCalculator', () => {
  ...
  describe('getStaffSpecificAvailability', () => {
    it('should return staff availability for date range', async () => {
      ...
      const uniqueDates = new Set(
        result.map((slot: any) => slot.startTime.toDateString())
      );
    ...
    it('should throw error for invalid staff context', async () => {
      ...
      await expect(
        AvailabilityCalculator.getStaffSpecificAvailability({
          businessId,
  ...
  describe('edge cases and error handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      asMock(mockPrisma.businessHours.findUnique).mockRejectedValue(
    ...
    it('should handle conflict detection engine errors', async () => {
      mockConflictEngine.validateAppointmentSlot.mockRejectedValue(
        new Error('Conflict engine error')
      );
