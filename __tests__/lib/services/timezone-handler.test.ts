...
describe('TimeZoneHandler', () => {
    ...
    describe('getTimeZoneInfo', () => {
        ...
        it('should return timezone info for specific date', () => {
            ...
            const summerInfo = TimeZoneHandler.getTimeZoneInfo('America/New_York', summerDate)

            // Test winter time (standard time)
            const winterDate = DateTime.fromISO('2024-01-15T12:00:00')
            const winterInfo = TimeZoneHandler.getTimeZoneInfo('America/New_York', winterDate)
    ...
    describe('localToUTC', () => {
        it('should convert local time to UTC correctly', () => {
            const utc = TimeZoneHandler.localToUTC('14:30', '2024-07-15', 'America/New_York')
        ...
        it('should handle different timezones', () => {
            const utcNY = TimeZoneHandler.localToUTC('12:00', '2024-07-15', 'America/New_York')
            const utcLondon = TimeZoneHandler.localToUTC('12:00', '2024-07-15', 'Europe/London')
            const utcTokyo = TimeZoneHandler.localToUTC('12:00', '2024-07-15', 'Asia/Tokyo')
    ...
    describe('timeSlotToLocal', () => {
        it('should convert UTC time slot to local', () => {
            ...
            const local = TimeZoneHandler.timeSlotToLocal(utcStart, utcEnd, 'America/New_York')
    ...
    describe('compareAcrossTimeZones', () => {
        it('should compare times correctly across timezones', () => {
            const time1 = { time: '14:00', date: '2024-07-15', timezone: 'America/New_York' }
            const time2 = { time: '19:00', date: '2024-07-15', timezone: 'Europe/London' }
        ...
        it('should return negative when first time is earlier', () => {
            const time1 = { time: '13:00', date: '2024-07-15', timezone: 'America/New_York' }
            const time2 = { time: '19:00', date: '2024-07-15', timezone: 'Europe/London' }
        ...
        it('should return positive when first time is later', () => {
            const time1 = { time: '15:00', date: '2024-07-15', timezone: 'America/New_York' }
            const time2 = { time: '19:00', date: '2024-07-15', timezone: 'Europe/London' }
    ...
    describe('getCurrentTimeInBusinessZone', () => {
        it('should return current time in business timezone', () => {
            const businessTime = TimeZoneHandler.getCurrentTimeInBusinessZone('America/New_York')
    ...
    describe('isValidTimeInZone', () => {
        it('should return true for valid times', () => {
            expect(TimeZoneHandler.isValidTimeInZone('14:30', '2024-07-15', 'America/New_York')).toBe(true)
            expect(TimeZoneHandler.isValidTimeInZone('00:00', '2024-07-15', 'UTC')).toBe(true)
            expect(TimeZoneHandler.isValidTimeInZone('23:59', '2024-07-15', 'Asia/Tokyo')).toBe(true)
        })

        it('should return false for invalid times', () => {
            expect(TimeZoneHandler.isValidTimeInZone('25:00', '2024-07-15', 'America/New_York')).toBe(false)
            expect(TimeZoneHandler.isValidTimeInZone('14:60', '2024-07-15', 'America/New_York')).toBe(false)
            expect(TimeZoneHandler.isValidTimeInZone('14:30', '2024-13-01', 'America/New_York')).toBe(false)
        })
        ...
        it('should handle DST gap times', () => {
            ...
            const isValid = TimeZoneHandler.isValidTimeInZone('02:30', '2024-03-10', 'America/New_York')
...
describe('MultiLocationTimeZoneManager', () => {
    ...
    beforeEach(() => {
        config = {
            ...
            locations: [
                { id: 'location-1', name: 'NYC Location', timezone: 'America/New_York' },
                { id: 'location-2', name: 'LA Location', timezone: 'America/Los_Angeles' },
                { id: 'location-3', name: 'London Location', timezone: 'Europe/London' }
            ]
        }
    ...
    describe('getLocationTimeZone', () => {
        it('should return location-specific timezone', () => {
            expect(manager.getLocationTimeZone('location-1')).toBe('America/New_York')
            expect(manager.getLocationTimeZone('location-2')).toBe('America/Los_Angeles')
            expect(manager.getLocationTimeZone('location-3')).toBe('Europe/London')
        })

        it('should return business default for unknown location', () => {
            expect(manager.getLocationTimeZone('unknown-location')).toBe('America/New_York')
        })
        ...
        it('should fallback to business timezone for invalid location timezone', () => {
            const invalidConfig = {
                ...
                timezone: 'America/New_York',
                locations: [
                    { id: 'location-1', name: 'Invalid Location', timezone: 'Invalid/Timezone' }
                ]
            }
            const invalidManager = new MultiLocationTimeZoneManager(invalidConfig)

            expect(invalidManager.getLocationTimeZone('location-1')).toBe('America/New_York')
        })
    })
    ...
    describe('normalizeAvailabilityAcrossLocations', () => {
        it('should normalize availability to UTC', () => {
            const availability = [
                { locationId: 'location-1', startTime: '09:00', endTime: '17:00', date: '2024-07-15' },
                { locationId: 'location-2', startTime: '09:00', endTime: '17:00', date: '2024-07-15' },
                { locationId: 'location-3', startTime: '09:00', endTime: '17:00', date: '2024-07-15' }
            ]

            const normalized = manager.normalizeAvailabilityAcrossLocations(availability)
    ...
    describe('getBusinessHoursAllLocations', () => {
        ...
        it('should handle business without locations', () => {
            ...
            const singleLocationManager = new MultiLocationTimeZoneManager(singleLocationConfig)

            const businessHours = singleLocationManager.getBusinessHoursAllLocations('2024-07-15')
