...
import { RealTimeSyncCallbacks, RealTimeSyncService } from '@/lib/services/real-time-sync-service';
...
describe('RealTimeSyncService', () => {
    ...
    describe('Optimistic Updates', () => {
        it('should apply optimistic update for appointment modification', () => {
            ...
            const updateId = service.applyOptimisticUpdate('apt-1', updates, 'update');
    ...
    describe('Server Update Handling', () => {
        it('should handle server update without conflicts', () => {
            ...
            expect(callbacks.onAppointmentUpdate).toHaveBeenCalledWith(updatedAppointment, false);
        });

        it('should detect conflicts with pending optimistic updates', () => {
            // Apply optimistic update first
            service.applyOptimisticUpdate('apt-1', { notes: 'Local update' }, 'update');
        ...
        it('should handle server appointment deletion', () => {
            ...
            expect(callbacks.onAppointmentDelete).toHaveBeenCalledWith('apt-1', false);
        });
    ...
    describe('Conflict Resolution', () => {
        it('should resolve conflict by accepting server version', () => {
            ...
            const conflictCall = (callbacks.onConflictDetected as jest.Mock).mock.calls[0][0];
    ...
    describe('Network State Management', () => {
        it('should handle online/offline state changes', () => {
            ...
            expect(callbacks.onNotification).toHaveBeenCalledWith('Working offline', 'warning');

            // Simulate going online
            Object.defineProperty(navigator, 'onLine', { value: true });
            window.dispatchEvent(new Event('online'));

            expect(callbacks.onNotification).toHaveBeenCalledWith('Connection restored', 'info');
        });
    ...
    describe('Force Sync', () => {
        it('should force sync all pending updates', async () => {
            ...
            expect(callbacks.onNotification).toHaveBeenCalledWith('Sync completed successfully', 'info');
        });
        ...
        it('should handle sync failures gracefully', async () => {
            ...
            expect(callbacks.onNotification).toHaveBeenCalledWith('Sync failed', 'error');
        });
