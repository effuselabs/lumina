...
describe('AppointmentStatusManager', () => {
  ...
  describe('getValidTransitions', () => {
    it('should return correct valid transitions for SCHEDULED', () => {
      const transitions = statusManager.getValidTransitions(
        AppointmentStatus.SCHEDULED
      );
  ...
  describe('updateStatus', () => {
    ...
    it('should successfully update status with valid transition', async () => {
      ...
      asMock(mockPrisma.appointmentStatusHistory.create).mockResolvedValue(
        {} as any
      );
    ...
    it('should reject invalid status transition', async () => {
      ...
      expect(result.error).toBe(
        'Invalid status transition from SCHEDULED to IN_PROGRESS'
      );
  ...
  describe('getStatusHistory', () => {
    it('should return status history for appointment', async () => {
      ...
      asMock(mockPrisma.appointmentStatusHistory.findMany).mockResolvedValue(
        mockHistory
      );

      const result = await statusManager.getStatusHistory(
        'appointment-1',
        'business-1'
      );
  ...
  describe('validateBusinessContext', () => {
    it('should return true for valid business context', async () => {
      ...
      const result = await statusManager.validateBusinessContext(
        'appointment-1',
        'business-1'
      );
  ...
  describe('triggerStatusEvents', () => {
    ...
    it('should handle errors gracefully', async () => {
      ...
      statusManager['handleStatusSpecificEvents'] = jest
        .fn()
  ...
  describe('getAppointmentsNeedingStatusUpdate', () => {
    it('should identify appointments needing status updates', async () => {
      ...
      const result =
        await statusManager.getAppointmentsNeedingStatusUpdate('business-1');
