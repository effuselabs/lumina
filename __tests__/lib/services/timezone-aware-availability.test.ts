...
describe('TimeZoneAwareAvailabilityCalculator', () => {
    ...
    beforeEach(() => {
        mockAvailabilityCalc = new mockAvailabilityCalculator() as jest.Mocked<AvailabilityCalculator>
        mockBusinessRepo = new mockBusinessHoursRepo() as jest.Mocked<BusinessHoursRepository>
        mockStaffRepo = new mockStaffAvailabilityRepo() as jest.Mocked<StaffAvailabilityRepository>
    ...
    describe('getAvailableSlots', () => {
        ...
        it('should handle invalid timezone', async () => {
            ...
            await expect(calculator.getAvailableSlots(request)).rejects.toThrow('Invalid timezone: Invalid/Timezone')
        })
    ...
    describe('validateAppointmentTime', () => {
        ...
        it('should reject invalid client timezone', async () => {
            ...
            expect(result.errors).toContain('Invalid client timezone: Invalid/Timezone')
        })
        ...
        it('should detect appointment outside business hours', async () => {
            ...
            expect(result.isValid).toBe(false)
            expect(result.errors).toContain('Appointment starts before business opens')
        })
        ...
        it('should detect appointment outside staff availability', async () => {
            ...
            expect(result.isValid).toBe(false)
            expect(result.errors).toContain('Staff member is not available on this date')
        })
...
describe('MultiLocationAvailabilityManager', () => {
    ...
    beforeEach(() => {
        ...
        manager = new MultiLocationAvailabilityManager(mockTimeZoneManager, mockCalculator)
    })
    ...
    describe('getAvailabilityAllLocations', () => {
        it('should get availability for all locations', async () => {
            const mockSlots: TimeZoneAwareTimeSlot[] = [
                ...
                ; (mockCalculator.getAvailableSlots as jest.Mock).mockResolvedValue(mockSlots)
