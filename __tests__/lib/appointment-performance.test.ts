...
const mockAppointment: DashboardAppointment = {
    ...
    status: 'confirmed',
    services: [
        { id: 'service-1', name: 'Haircut', duration: 60, price: 50 }
    ],
    totalPrice: 50,
    totalDuration: 60,
...
class MockPerformanceMonitor {
    ...
    generateReport() {
        return {
            ...
            metrics: {
                averageCalendarLoadTime: this.getAverageMetric('appointment-calendar-load'),
...
describe('Appointment Search Index', () => {
    ...
    test('should provide search suggestions', () => {
        ...
        const suggestions = appointmentSearchIndex.getSuggestions('business-1', 'Jo');
...
describe('Performance Monitor', () => {
    ...
    test('should calculate average metrics', () => {
        ...
        const average = appointmentPerformanceMonitor.getAverageMetric('test-metric');
    ...
    test('should measure function execution time', () => {
        ...
        const result = appointmentPerformanceMonitor.measureFunction('test-function', testFunction);
    ...
    test('should measure async function execution time', async () => {
        ...
        const result = await appointmentPerformanceMonitor.measureAsync('test-async', asyncFunction);
    ...
    test('should generate performance report', () => {
        appointmentPerformanceMonitor.recordMetric('appointment-calendar-load', 500);
    ...
    test('should calculate percentiles', () => {
        ...
        const percentiles = appointmentPerformanceMonitor.getPercentiles('test-percentiles');
...
describe('Performance Optimization Edge Cases', () => {
    ...
    test('should handle performance monitoring with no metrics', () => {
        appointmentPerformanceMonitor.clearMetrics();
        const average = appointmentPerformanceMonitor.getAverageMetric('nonexistent');
        expect(average).toBe(0);

        const percentiles = appointmentPerformanceMonitor.getPercentiles('nonexistent');
