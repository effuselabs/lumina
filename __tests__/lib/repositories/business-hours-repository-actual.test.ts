...
describe('BusinessHoursRepository', () => {
  ...
  describe('getBusinessHoursForDate', () => {
    it('should return business hours and holiday for specific date', async () => {
      ...
      asMock(mockPrisma.businessHours.findFirst).mockResolvedValue(
        mockBusinessHours
      );
      asMock(mockPrisma.businessHoliday.findFirst).mockResolvedValue(
        mockHoliday
      );

      const result = await repository.getBusinessHoursForDate(
        businessId,
        testDate
      );
  ...
  describe('getHolidays', () => {
    it('should return holidays for date range', async () => {
      ...
      const result = await repository.getHolidays(
        businessId,
        startDate,
        endDate
      );
  ...
  describe('validateBusinessHours', () => {
    it('should return valid for correct business hours', async () => {
      const result = await repository.validateBusinessHours(
        businessId,
        '09:00',
        '17:00',
        1
  ...
  describe('error handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      await expect(repository.getBusinessHours(businessId)).rejects.toThrow(
        'Database error'
      );
    });
