...
describe('TimeOffRequestRepository', () => {
  ...
  describe('createTimeOffRequest', () => {
    it('should create a new time-off request', async () => {
      ...
      const result = await repository.createTimeOffRequest(
        staffId,
        businessId,
        requestData
      );
  ...
  describe('getTimeOffRequests', () => {
    ...
    it('should filter by status when provided', async () => {
      ...
      const result = await repository.getTimeOffRequests(
        businessId,
  ...
  describe('denyTimeOff', () => {
    it('should deny a time-off request with reason', async () => {
      ...
      const result = await repository.denyTimeOff(
        requestId,
        approverId,
        denialReason
      );
  ...
  describe('deleteTimeOffRequest', () => {
    it('should delete time-off request', async () => {
      ...
      asMock(mockPrisma.timeOffRequest.delete).mockResolvedValue(
        mockDeletedRequest
      );
  ...
  describe('error handling', () => {
    it('should handle database errors gracefully', async () => {
      asMock(mockPrisma.timeOffRequest.findMany).mockRejectedValue(
        new Error('Database error')
      );

      await expect(repository.getTimeOffRequests(businessId)).rejects.toThrow(
        'Database error'
      );
    });
    ...
    it('should validate required parameters', async () => {
      await expect(
        repository.createTimeOffRequest('', businessId, {
          startDate: new Date(),
          endDate: new Date(),
          reason: 'Test',
        })
    ...
    it('should validate date ranges', async () => {
      ...
      await expect(
        repository.createTimeOffRequest(staffId, businessId, invalidData)
      ).rejects.toThrow();
    });
  });
});
