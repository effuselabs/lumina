...
describe('Public Booking Accessibility Tests', () => {
    describe('Service Selection Accessibility', () => {
        ...
        test('should have proper ARIA labels and roles', async () => {
            ...
            // Verify main heading
            expect(screen.getByRole('heading', { name: /select services/i })).toBeInTheDocument()
            ...
            expect(screen.getByText('$50.00')).toHaveAttribute('aria-label', 'Price: 50 dollars')
            expect(screen.getByText('$100.00')).toHaveAttribute('aria-label', 'Price: 100 dollars')
        })
        ...
        test('should support keyboard navigation', async () => {
            ...
            const secondService = screen.getByRole('button', { name: /hair coloring/i })
        ...
        test('should announce selection changes to screen readers', async () => {
            ...
            expect(selectedService).toHaveAttribute('aria-label',
    ...
    describe('Time Selection Accessibility', () => {
        ...
        test('should handle unavailable slots accessibly', async () => {
            ...
            expect(unavailableSlot).toHaveAttribute('aria-label',
    ...
    describe('Booking Confirmation Accessibility', () => {
        const mockAppointment = {
            ...
            client: { firstName: 'Jane', lastName: 'Smith', email: 'jane@example.com', phone: '555-0123' },
            totalDuration: 60,
            totalPrice: 50,
        ...
        test('should announce confirmation to screen readers', async () => {
            ...
            expect(liveRegion).toHaveTextContent(/your appointment has been confirmed/i)

            // Verify confirmation number is prominently displayed
            expect(screen.getByText('CONF-123')).toHaveAttribute('aria-label',
        ...
        test('should have accessible appointment details', async () => {
            ...
            const detailsList = screen.getByRole('list', { name: /appointment details/i })
    ...
    describe('Overall Interface Accessibility', () => {
        ...
        test('should support high contrast mode', async () => {
            ...
            buttons.forEach(button => {
                expect(button).toHaveClass(expect.stringMatching(/high-contrast|border/))
            })
        })
