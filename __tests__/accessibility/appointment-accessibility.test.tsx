...
describe.skip('Appointment Management Accessibility', () => {
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should support arrow key navigation in calendar grid', () => {
      ...
      // Navigate down
      fireEvent.keyDown(screen.getByTestId('appointment-block-2'), {
        key: 'ArrowDown',
      });
  ...
  describe('ARIA Labels and Roles', () => {
    ...
    it('should have proper ARIA labels on appointments', () => {
      ...
      expect(appointment).toHaveAttribute(
        'aria-label',
        expect.stringContaining(
          'John Doe, Haircut, 9:00 AM to 10:00 AM, Alice Johnson'
        )
      );
    });
  ...
  describe('Screen Reader Support', () => {
    it('should announce appointment details to screen readers', () => {
      ...
      const description = document.getElementById(
        appointment.getAttribute('aria-describedby')!
      );
  ...
  describe('Mobile Accessibility', () => {
    it('should support touch accessibility features', () => {
      ...
      expect(parseInt(computedStyle.minHeight)).toBeGreaterThanOrEqual(
        minTouchTarget
      );
      expect(parseInt(computedStyle.minWidth)).toBeGreaterThanOrEqual(
        minTouchTarget
      );
    });
