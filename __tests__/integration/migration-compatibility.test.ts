  ...
  describe('Backward Compatibility Service Integration', () => {
    describe('Business Hours Compatibility', () => {
      it('should return structured data when available', async () => {
        ...
        const result =
          await backwardCompatibilityService.getBusinessHours(businessId);
    ...
    describe('Staff Availability Compatibility', () => {
      it('should return structured data when available', async () => {
        ...
        asMock(mockPrisma.staffAvailability.findMany).mockResolvedValue(
          mockStructuredAvailability
        );

        const result =
          await backwardCompatibilityService.getStaffAvailability(staffId);
    ...
    describe('Migration Status Checking', () => {
      it('should identify migration candidates', async () => {
        ...
        const result =
          await backwardCompatibilityService.getMigrationCandidates();
      ...
      it('should check availability status for business hours', async () => {
        ...
        const result =
          await backwardCompatibilityService.hasBusinessHours(businessId);
      ...
      it('should check availability status for staff availability', async () => {
        ...
        const result =
          await backwardCompatibilityService.hasStaffAvailability(staffId);
    ...
    describe('Force Migration', () => {
      it('should force migrate business hours', async () => {
        ...
        const result =
          await backwardCompatibilityService.forceMigrateBusiness(businessId);
      ...
      it('should force migrate staff availability', async () => {
        ...
        const result =
          await backwardCompatibilityService.forceMigrateStaff(staffId);
    ...
    describe('Deprecation Statistics', () => {
      it('should provide comprehensive deprecation statistics', async () => {
        ...
        const result =
          await backwardCompatibilityService.getDeprecationStatistics();
  ...
  describe('Data Migration Service Integration', () => {
    describe('Full Migration Process', () => {
      ...
      it('should rollback on critical errors', async () => {
        ...
        expect(result.success).toBe(false);
        expect(
          result.errors.some((e: any) => e.error.includes('validation failed'))
        ).toBe(true);
      });
    });
    ...
    describe('Migration Validation', () => {
      ...
      it('should detect integrity issues', async () => {
        ...
        expect(
          result.errors.some((e: any) => e.field === 'businessHours')
        ).toBe(true);
      });
    });
    ...
    describe('Migration Rollback', () => {
      it('should rollback migration successfully', async () => {
        ...
        const result =
          await dataMigrationService.rollbackMigration(rollbackData);
