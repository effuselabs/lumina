      ...
      <div data-testid="appointments-list">
        {appointments.map(appointment => (
          ...
          >
            ...
            <button
              onClick={() =>
                updateAppointment(appointment.id, { notes: 'Updated notes' })
              }
...
describe('Real-Time Appointments Integration', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should display real-time status component', () => {
      ...
      expect(
        screen.getByRole('button', { name: /real-time settings/i })
      ).toBeInTheDocument();
    });
  ...
  describe('Appointment Operations', () => {
    ...
    it('should delete appointment optimistically', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByTestId('appointment-apt-1')
  ...
  describe('Conflict Resolution', () => {
    it('should display conflicts when they occur', () => {
      ...
      expect(
        screen.getByText('Conflict detected for appointment apt-1')
      ).toBeInTheDocument();
    });
    ...
    it('should open conflict resolution modal', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Appointment Conflict Detected')
        ).toBeInTheDocument();
      });
    });
  });
