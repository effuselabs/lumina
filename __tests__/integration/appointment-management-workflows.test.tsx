...
describe('Appointment Management Workflows', () => {
  ...
  describe('Appointment Editing Workflow', () => {
    it('should edit existing appointment', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText('Appointment Details')
    ...
    it('should handle service change with price recalculation', async () => {
      const updatedAppointment = {
        ...mockAppointments[0],
        services: [
          { id: 'service-2', name: 'Color Treatment', price: 75, duration: 90 },
        ],
        totalPrice: 75,
        totalDuration: 90,
      };
  ...
  describe('Appointment Cancellation Workflow', () => {
    it('should cancel appointment with confirmation', async () => {
      ...
      // Verify API call
      await waitFor(() => {
        expect(mockApiCalls.deleteAppointment).toHaveBeenCalledWith(
          'appointment-1'
        );
      });
      ...
      await waitFor(() => {
        expect(
          screen.queryByTestId('appointment-block-1')
        ).not.toBeInTheDocument();
      });
    });
  });
  ...
  describe('Error Handling Workflows', () => {
    it('should handle API errors gracefully', async () => {
      mockApiCalls.createAppointment.mockRejectedValue(
    ...
    it('should handle network connectivity issues', async () => {
      mockApiCalls.getAppointments.mockRejectedValue(
