...
describe('ClientInformationForm', () => {
    ...
    describe('Form Validation', () => {
        it('validates required fields', async () => {
            ...
            const submitButton = screen.getByRole('button', { name: /continue to confirmation/i });
    ...
    describe('Client Lookup Functionality', () => {
        ...
        it('shows loading state during client lookup', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/checking for existing account/i)).toBeInTheDocument();
            });
        });
        ...
        it('handles client lookup errors gracefully', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/unable to check client information/i)).toBeInTheDocument();
            }, { timeout: 2000 });
        });
    });
    ...
    describe('Form Submission', () => {
        it('submits form with valid data for new client', async () => {
            ...
            await user.type(screen.getByLabelText(/special requests/i), 'No allergies');
    ...
    describe('Initial Data', () => {
        it('pre-fills form with initial data', () => {
            ...
            render(<ClientInformationForm {...mockProps} initialData={initialData} />);
