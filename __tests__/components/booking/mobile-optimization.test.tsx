...
const mockUseBookingPerformance = useBookingPerformance as jest.MockedFunction<typeof useBookingPerformance>;

// Mock performance hooks
const mockUsePerformanceMonitor = require('@/lib/performance-hooks').usePerformanceMonitor as jest.MockedFunction<any>;
...
describe('Mobile Optimization', () => {
    ...
    describe('MobileOptimizedBooking', () => {
        ...
        it('prevents navigation during loading', () => {
            const onNext = jest.fn();
            render(<MobileOptimizedBooking {...defaultProps} onNext={onNext} isLoading={true} />);
    ...
    describe('ProgressiveLoading', () => {
        ...
        it('shows offline message when not connected', () => {
            ...
            expect(screen.getByText('Offline - content unavailable')).toBeInTheDocument();
        });
    });
    ...
    describe('OfflineSupport', () => {
        ...
        it('shows offline mode when not connected and offline mode enabled', () => {
            ...
            expect(screen.getByText('Offline Mode - Limited functionality available')).toBeInTheDocument();
        });
    });
