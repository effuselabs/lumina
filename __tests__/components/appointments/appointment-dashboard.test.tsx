...
describe('AppointmentDashboard', () => {
    ...
    describe('Calendar View Switching', () => {
        ...
        it('should maintain selected date when switching views', async () => {
            renderWithProviders(<AppointmentDashboard businessId="business-1" initialDate={new Date('2024-01-15')} />)
    ...
    describe('Accessibility', () => {
        it('should support keyboard navigation', () => {
            ...
            expect(document.activeElement).toBe(screen.getByTestId('appointment-block-2'))
        })
