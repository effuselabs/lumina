...
describe('CalendarView', () => {
    ...
    describe('Week View', () => {
        ...
        it('should display appointments across multiple days', () => {
            ...
            renderWithDnd(<CalendarView {...mockProps} view="week" appointments={weekAppointments} />)
    ...
    describe('Month View', () => {
        ...
        it('should show appointment indicators', () => {
            ...
            expect(dayCell.querySelector('.appointment-indicator')).toBeInTheDocument()
        })
    ...
    describe('Conflict Visualization', () => {
        it('should highlight conflicting appointments', () => {
            ...
            renderWithDnd(<CalendarView {...mockProps} appointments={conflictingAppointments} />)

            const conflictedAppointment = screen.getByTestId('appointment-block-conflict')
        ...
        it('should show conflict tooltip', async () => {
            const conflictingAppointments = [
                {
                    ...mockAppointments[0],
                    isConflicted: true,
                    conflicts: [{ type: 'overlap', message: 'Overlaps with another appointment' }]
                }
            ]
            ...
            await waitFor(() => {
                expect(screen.getByText('Overlaps with another appointment')).toBeInTheDocument()
            })
        })
    })
    ...
    describe('Performance', () => {
        it('should virtualize large appointment lists', () => {
            ...
            renderWithDnd(<CalendarView {...mockProps} appointments={manyAppointments} />)
