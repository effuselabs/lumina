...
import { mockAppointments, mockServices } from '@/test-utils/appointment-mocks'
...
describe('AppointmentModal', () => {
    ...
    describe('View Mode', () => {
        ...
        it('should show delete button for cancellable appointments', () => {
            ...
            renderWithProviders(
                <AppointmentModal {...mockProps} appointment={cancellableAppointment} mode="view" />
            )
        ...
        it('should not show edit button for non-editable appointments', () => {
            ...
            renderWithProviders(
                <AppointmentModal {...mockProps} appointment={nonEditableAppointment} mode="view" />
            )
    ...
    describe('Create Mode', () => {
        it('should display empty form in create mode', () => {
            renderWithProviders(<AppointmentModal {...mockProps} appointment={null} mode="create" />)
    ...
    describe('Staff Assignment', () => {
        ...
        it('should check staff availability', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/staff member not available/i)).toBeInTheDocument()
            })
        })
    })
    ...
    describe('Notes and Comments', () => {
        it('should display existing notes', () => {
            ...
            renderWithProviders(<AppointmentModal {...mockProps} appointment={appointmentWithNotes} />)

            expect(screen.getByText('Client prefers window seat')).toBeInTheDocument()
        })
    ...
    describe('Loading States', () => {
        it('should show loading state while saving', async () => {
            ...
            renderWithProviders(<AppointmentModal {...mockProps} mode="edit" onSave={slowSave} />)
        ...
        it('should show loading state while deleting', async () => {
            const slowDelete = jest.fn(() => new Promise(resolve => setTimeout(resolve, 1000)))

            renderWithProviders(
                <AppointmentModal
                    {...mockProps}
                    appointment={{ ...mockAppointments[0], canCancel: true }}
                    onDelete={slowDelete}
                />
            )
