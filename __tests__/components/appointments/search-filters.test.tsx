...
const mockStaffMembers = [
    { id: '1', firstName: 'John', lastName: 'Doe', displayName: 'John D.', color: '#FF0000', isActive: true },
    { id: '2', firstName: 'Jane', lastName: 'Smith', displayName: 'Jane S.', color: '#00FF00', isActive: true }
];

const mockServices = [
    { id: '1', name: 'Haircut', category: 'Hair', duration: 60, price: 5000, isActive: true },
    { id: '2', name: 'Manicure', category: 'Nails', duration: 45, price: 3500, isActive: true }
];
...
describe('SearchFilters', () => {
    ...
    it('renders search input', () => {
        ...
        expect(screen.getByPlaceholderText('Search appointments, clients, services...')).toBeInTheDocument();
    });
    ...
    it('calls onFilterChange when search term changes', async () => {
        ...
        const searchInput = screen.getByPlaceholderText('Search appointments, clients, services...');
