...
describe('Button Component - Accessibility', () => {
    ...
    describe('ARIA Attributes', () => {
        ...
        it('uses custom aria-label when provided', () => {
            render(<Button size="icon" aria-label="Add user"><User /></Button>);
            const button = screen.getByRole('button');
    ...
    describe('Screen Reader Support', () => {
        ...
        it('announces loading state to screen readers', () => {
            ...
            const loadingAnnouncement = screen.getByText('Loading', { selector: '.sr-only' });
    ...
    describe('Focus Management', () => {
        ...
        it('has proper focus ring colors for different variants', () => {
            const variants = [
                { variant: 'primary' as const, expectedRing: 'focus-visible:ring-lumina-gold' },
                { variant: 'secondary' as const, expectedRing: 'focus-visible:ring-deep-teal' },
                { variant: 'outline' as const, expectedRing: 'focus-visible:ring-lumina-gold' },
                { variant: 'ghost' as const, expectedRing: 'focus-visible:ring-lumina-gold' },
                { variant: 'destructive' as const, expectedRing: 'focus-visible:ring-red-600' },
                { variant: 'link' as const, expectedRing: 'focus-visible:ring-lumina-gold' },
            ];
    ...
    describe('High Contrast Mode Support', () => {
        it('has contrast-more classes for high contrast mode', () => {
            const variants = [
                { variant: 'primary' as const, expectedClass: 'contrast-more:border-2' },
                { variant: 'secondary' as const, expectedClass: 'contrast-more:border-2' },
                { variant: 'outline' as const, expectedClass: 'contrast-more:border-4' },
                { variant: 'ghost' as const, expectedClass: 'contrast-more:border-2' },
                { variant: 'destructive' as const, expectedClass: 'contrast-more:border-2' },
