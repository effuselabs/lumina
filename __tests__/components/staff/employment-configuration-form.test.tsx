...
jest.mock('@/components/staff/employment-calculation-preview', () => ({
    EmploymentCalculationPreview: () => <div data-testid="calculation-preview">Preview</div>,
}));
...
describe('EmploymentConfigurationForm', () => {
    ...
    it('renders employment type selection', () => {
        ...
        expect(screen.getByText('Choose how this staff member will be compensated')).toBeInTheDocument();
    });
