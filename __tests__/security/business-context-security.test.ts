...
describe('BusinessContextSecurityService', () => {
  ...
  describe('validateBusinessContext', () => {
    ...
    it('should reject invalid business context - user not in business', async () => {
      ...
      expect(result.violations[0].type).toBe(
        SecurityViolationType.INVALID_BUSINESS_CONTEXT
      );
    ...
    it('should handle non-existent user', async () => {
      ...
      expect(result.violations).toHaveLength(1);
      expect(result.violations[0].type).toBe(
        SecurityViolationType.UNAUTHORIZED_BUSINESS_ACCESS
      );
    });
  });
  ...
  describe('validateResourceOwnership', () => {
    ...
    it('should reject invalid resource ownership', async () => {
      ...
      expect(result.violations).toHaveLength(1);
      expect(result.violations[0].type).toBe(
        SecurityViolationType.INVALID_RESOURCE_OWNERSHIP
      );
    });
  });
  ...
  describe('getSecurityViolations', () => {
    ...
    it('should retrieve security violations for business', async () => {
      const result =
        await businessContextSecurity.getSecurityViolations(testBusinessId);
    ...
    it('should filter violations by type', async () => {
      const result = await businessContextSecurity.getSecurityViolations(
        testBusinessId,
        {
  ...
  describe('Multi-tenant isolation tests', () => {
    ...
    it('should isolate security violations by business', async () => {
      ...
      const business1Violations =
        await businessContextSecurity.getSecurityViolations(testBusinessId);
      const business2Violations =
        await businessContextSecurity.getSecurityViolations(otherBusinessId);
