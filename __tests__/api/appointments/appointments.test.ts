...
describe('Appointments API', () => {
    ...
    describe('GET /api/appointments', () => {
        it('should return appointments with valid business access', async () => {
            ...
            const url = new URL('http://localhost/api/appointments?businessId=business-123&limit=20&offset=0')
        ...
        it('should handle validation errors for query parameters', async () => {
            const url = new URL('http://localhost/api/appointments?businessId=business-123&limit=invalid')
            const request = new NextRequest(url)
    ...
    describe('GET /api/appointments/[id]', () => {
        it('should return appointment by ID with valid access', async () => {
            ...
            const response = await getById(request, { params: { id: 'appointment-123' } })
            const data = await response.json()
        ...
        it('should return 404 when appointment not found', async () => {
            ...
            const url = new URL('http://localhost/api/appointments/nonexistent?businessId=business-123')
            const request = new NextRequest(url)
        ...
        it('should include conflicts and availability when requested', async () => {
            ...
            const url = new URL('http://localhost/api/appointments/appointment-123?businessId=business-123&includeConflicts=true&validateAvailability=true')
            const request = new NextRequest(url)
