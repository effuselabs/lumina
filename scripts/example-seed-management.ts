...
async function demonstrateDataManagement() {
    ...
    try {
        ...
        if (demoScenario) {
            const configValidation = resetManager.validateConfiguration(demoScenario.config as any);
        ...
        try {
            const validationResult = await resetManager.validateDataIntegrity(businessId);
            console.log(`  Data valid: ${validationResult.isValid ? '✅' : '❌'}`);
            console.log(`  Total entities: ${validationResult.summary.totalEntities}`);
            console.log(`  Critical errors: ${validationResult.summary.criticalErrors}`);
        ...
        console.log('  npm run seed:manage reset -b business-123 --dry-run --verbose');
        console.log('');
        console.log('  # Reset with preservation');
        console.log('  npm run seed:manage reset -b business-123 --preserve-users --preserve-business');
        console.log('');
        ...
        console.log('  npm run seed:manage report -b business-123 -o data-report.md');
        console.log('');
