...
const testSuites: TestSuite[] = [
    ...
    },
    {
        ...
        description: 'Performance tests for calendar rendering and real-time updates',
        timeout: 120000
    },
    {
        name: 'accessibility',
        pattern: '__tests__/accessibility/appointment-accessibility.test.tsx',
        description: 'Accessibility tests for keyboard navigation and screen readers',
        timeout: 45000
    },
    {
        name: 'e2e',
        pattern: 'e2e/appointment-management.spec.ts',
        description: 'End-to-end tests for complete appointment management scenarios',
        timeout: 300000
    },
    {
        name: 'mobile-e2e',
        pattern: 'e2e/mobile-appointment-management.spec.ts',
        description: 'Mobile device testing for touch interactions and responsive design',
        timeout: 300000
    }
]
...
class AppointmentTestRunner {
    ...
    private printSummary(results: Array<{ suite: string; success: boolean; duration: number }>): void {
        console.log('\n📊 TEST SUMMARY')
        console.log('='.repeat(50))
