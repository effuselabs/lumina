...
class ComprehensiveTestRunner {
    ...
    async runAllTests(): Promise<void> {
        ...
        const testSuites: TestSuite[] = [
            ...
            {
                name: 'Accessibility',
                command: 'playwright test e2e/accessibility/accessibility-regression.spec.ts',
                description: 'WCAG 2.1 AA compliance testing with axe-core',
                required: true
            },
            {
                name: 'Keyboard Navigation',
                command: 'playwright test e2e/accessibility/keyboard-navigation.spec.ts',
                description: 'Comprehensive keyboard navigation testing',
                required: true
            },
            {
                name: 'Performance',
                command: 'playwright test e2e/performance/performance-regression.spec.ts',
    ...
    private generateReport(): void {
        ...
        writeFileSync('test-results/comprehensive/test-results.json', JSON.stringify(jsonReport, null, 2));
...
`;
    ...
    private printSummary(): void {
        ...
        const totalDuration = (this.results.reduce((sum, r) => sum + r.duration, 0) / 1000).toFixed(2);
