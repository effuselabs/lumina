...
describe('ServiceCompatibilityValidator', () => {
  ...
  beforeEach(() => {
    serviceValidator = new ServiceCompatibilityValidator(
      mockPrisma,
      businessId
    );
    jest.clearAllMocks();
...
describe('FinancialIntegrityValidator', () => {
  ...
  beforeEach(() => {
    financialValidator = new FinancialIntegrityValidator(
      mockPrisma,
      businessId
    );
    jest.clearAllMocks();
  ...
  describe('validateTransactionAmounts', () => {
    it('should return error if appointment not found', async () => {
      ...
      const result =
        await financialValidator.validateTransactionAmounts('invalid-id');
    ...
    it('should return error if payment missing for completed appointment', async () => {
      ...
      const result =
        await financialValidator.validateTransactionAmounts('appointment-id');
...
describe('BusinessLogicValidator', () => {
  ...
  describe('validateAppointmentBooking', () => {
    ...
    it('should validate appointment booking comprehensively', async () => {
      ...
      const result =
        await businessValidator.validateAppointmentBooking(appointmentData);
