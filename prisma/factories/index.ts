...
export async function validateBusinessContext(
  ...
  console.log(
    `✅ Business context validated: ${business.name} (${business.slug})`
  );
  return business;
}
...
export async function cleanExistingSeedData(
  ...
  try {
    await prisma.$transaction(async tx => {
      ...
      console.log(
        `  Deleted ${loyaltyTransactionsDeleted.count} loyalty transactions`
      );
      ...
      console.log(
        `  Deleted ${loyaltyMembershipsDeleted.count} loyalty memberships`
      );
      ...
      console.log(
        `  Deleted ${campaignRecipientsDeleted.count} campaign recipients`
      );
      ...
      console.log(
        `  Deleted ${marketingCampaignsDeleted.count} marketing campaigns`
      );
      ...
      console.log(
        `  Deleted ${promotionUsageDeleted.count} promotion usage records`
      );
      ...
      console.log(
        `  Deleted ${giftCardRedemptionsDeleted.count} gift card redemptions`
      );
