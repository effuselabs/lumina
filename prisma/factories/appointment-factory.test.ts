...
describe('AppointmentFactory', () => {
    ...
    describe('initialization', () => {
        it('should load clients, staff, and services', async () => {
            // Mock data
            const mockClients = [
                { id: 'client1', firstName: 'John', lastName: 'Doe', email: 'john@example.com', phone: '555-0001' },
                { id: 'client2', firstName: 'Jane', lastName: 'Smith', email: 'jane@example.com', phone: '555-0002' },
            ];

            const mockStaff = [
                { id: 'staff1', displayName: 'Alice Johnson', workingHours: { monday: { startTime: '09:00', endTime: '17:00' } } },
                { id: 'staff2', displayName: 'Bob Wilson', workingHours: { tuesday: { startTime: '10:00', endTime: '18:00' } } },
            ];

            const mockServices = [
                { id: 'service1', name: 'Haircut', duration: 60, price: 65, category: 'Hair' },
                { id: 'service2', name: 'Hair Color', duration: 120, price: 120, category: 'Hair' },
            ];
    ...
    describe('appointment generation', () => {
        ...
        it('should generate a valid appointment', async () => {
            ...
            (mockPrisma.appointment.create as jest.Mock).mockResolvedValue(mockAppointment);
            (mockPrisma.appointmentService.createMany as jest.Mock).mockResolvedValue({ count: 1 });
    ...
    describe('validation', () => {
        ...
        it('should validate time logic', () => {
            ...
            expect(result.isValid).toBe(false);
            expect(result.errors.some((e: any) => e.code === 'INVALID_RANGE')).toBe(true);
        });
        ...
        it('should validate deposit amount', () => {
            ...
            expect(result.isValid).toBe(false);
            expect(result.errors.some((e: any) => e.code === 'INVALID_VALUE')).toBe(true);
        });
    ...
    describe('historical appointment generation', () => {
        ...
        it('should call progress callback during generation', async () => {
            ...
            expect(progressCallback).toHaveBeenLastCalledWith(targetCount, targetCount);
        });
    });
});