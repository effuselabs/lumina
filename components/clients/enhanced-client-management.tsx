          ...
          action={
            Object.keys(filterValues).length === 0
              ? {
                  ...
                  onClick: () => {
                    // This would trigger the parent's create dialog
                    // console.log('Add first client clicked');
                  },
                }
              : undefined
          }
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-lumina-primary font-semibold">
                        {client.firstName} {client.lastName}
                      </h3>
                      <div className="mt-1 flex items-center gap-2">
                        {client.status && (
                          <StatusBadge variant={getStatusColor(client.status)}>
              ...
              <CardContent className="space-y-3">
                ...
                {client.lastAppointment && (
                  <div className="border-t pt-3">
                    ...
                    <div className="text-lumina-primary mt-1 text-sm">
                      {formatDistanceToNow(
                ...
                <div className="flex gap-2 pt-3">
                  <button
                    ...
                    className="text-lumina-primary flex-1 rounded-md bg-gray-100 px-3 py-2 text-xs font-medium transition-colors hover:bg-gray-200"
                  >
                  ...
                  <button
                    onClick={e => {
                      e.stopPropagation();
                      // TODO: Quick book appointment
                      // console.log('Quick book for', client.firstName);
                    }}
                    className="flex-1 rounded-md px-3 py-2 text-xs font-medium text-white transition-colors"
                    style={{
                      background:
                        'linear-gradient(135deg, #ffd25a 0%, #ff7a5a 100%)',
                    }}
