    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <FormField label="Send email marketing and appointment reminders">
            <input
              type="checkbox"
              id="emailMarketing"
          ...
          <FormField label="Send SMS marketing and appointment reminders">
            <input
              type="checkbox"
              id="smsMarketing"
              checked={formData.smsMarketing}
              onChange={e =>
                handleInputChange('smsMarketing', e.target.checked)
              }
              className="form-checkbox"
            />
          </FormField>
