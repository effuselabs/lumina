  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-orange-100 to-orange-200">
          {result.success ? (
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-green-700">
                {result.imported} clients have been added to your database and
                are ready to book appointments.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-yellow-700">
                {result.skipped} clients were skipped because they already exist
                in your database (matched by email or phone number).
              </p>
            </div>
          </div>
        </div>
      ...
      {result.errors.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="max-h-64 overflow-y-auto rounded-lg border border-red-200 bg-red-50 p-4">
            <div className="space-y-2">
              ...
              {result.errors.length > 20 && (
                <div className="text-sm font-medium text-red-600">
                  ... and {result.errors.length - 20} more errors. Download the
                  full report above.
                </div>
              )}
            </div>
