...
export function DataMapping({
    ...
    const [mapping, setMapping] = useState<FieldMapping>(getDefaultFieldMapping());
    ...
    useEffect(() => {
        ...
        ourFields.forEach(ourField => {
            ...
            let matchedHeader = previewData.headers.find(header =>
                header.toLowerCase().trim() === defaultCsvField.toLowerCase()
            );
            ...
            if (!matchedHeader) {
                ...
                matchedHeader = previewData.headers.find(header => {
                    const headerLower = header.toLowerCase().trim();
                    return alts.some(alt => headerLower.includes(alt) || alt.includes(headerLower));
                });
            }
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Match your CSV columns to our client fields. Required fields are marked with *.
                </p>
            </div>
                            ...
                            <div key={ourField} className="space-y-2">
                                ...
                                >
                                    <SelectTrigger className={cn(
                                        isRequired && !mapping[ourField] && 'border-red-300 focus:border-red-500 focus:ring-red-500'
                                    )}>
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        {Object.keys(mapping).filter(field => mapping[field]).map(field => (
