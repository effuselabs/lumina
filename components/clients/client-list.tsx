...
export function ClientList({
  ...
  }, [businessId, currentPage, searchTerm, selectedStaff, sortBy, sortOrder]);
  ...
  }, [searchTerm, selectedStaff, currentPage]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between text-sm text-gray-600">
        ...
        {(searchTerm || (selectedStaff && selectedStaff !== 'all')) && (
          <Button
            variant="ghost"
            size="sm"
            onClick={() => {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Recent Appointment</TableHead>
                  ...
                  {client.lastAppointment ? (
                    <div className="text-sm">
                      ...
                      <div className="text-xs text-gray-400">
                        {new Date(client.lastAppointment.startTime) > new Date()
                          ? 'Upcoming'
                          : 'Completed'}
                      </div>
                    </div>
