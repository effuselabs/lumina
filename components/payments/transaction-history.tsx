...
export default function TransactionHistory({
    ...
    useEffect(() => {
        fetchTransactions();
    }, [businessId, staffId, typeFilter, statusFilter, employmentTypeFilter, startDate, endDate]);
    ...
    const filteredTransactions = transactions.filter(transaction =>
        ...
        transaction.appointment?.clientName?.toLowerCase().includes(searchTerm.toLowerCase())
    );
                        ...
                        {totalPages > 1 && (
                            <div className="flex items-center justify-between mt-4">
                                <p className="text-sm text-gray-500">
                                    ...
                                    {Math.min(currentPage * (maxItems || 50), totalCount)} of {totalCount} transactions
                                </p>
