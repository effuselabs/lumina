...
export default function POSInterface({
    ...
    const fetchAppointment = async () => {
        ...
        try {
            ...
            setError(error instanceof Error ? error.message : 'Failed to fetch appointment');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const calculateSubtotal = () => {
        ...
        return appointment.services.reduce((sum, service) => sum + service.price, 0);
    };
                ...
                <CardContent className="pt-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                            Payment of {formatCurrency(calculateTotal())} has been processed successfully.
                        </p>
                ...
                <CardHeader>
                    ...
                    <CardDescription>
                        <div className="flex items-center gap-4">
                            ...
                            <Badge variant="outline">{appointment.staff.employmentType}</Badge>
                        </div>
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        {tipAmount > 0 && (
                            <div className="p-3 bg-green-50 rounded-lg">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-green-700 font-bold">{formatCurrency(tipAmount)}</span>
                                </div>
                            </div>
                        )}
                    </CardContent>
