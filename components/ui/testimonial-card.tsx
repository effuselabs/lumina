      ...
      >
        ...
        >
          ...
          <div className="testimonial-quote-icon mb-4">
            <svg
              className="h-8 w-8 text-lumina-gold opacity-60"
              fill="currentColor"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
          ...
          <blockquote
            className={cn(
              'testimonial-quote mb-6 text-foreground',
          ...
          {rating && (
            <div
              className="testimonial-rating mb-4 flex items-center"
          ...
          <div className="testimonial-author flex items-center">
            ...
            <div
              className={cn(
                'testimonial-avatar mr-4 flex-shrink-0',
            ...
            >
              {avatar && avatar.startsWith('http') ? (
                <Image
                  ...
                  width={48}
                  height={48}
                  className="h-full w-full rounded-full border-2 border-background object-cover shadow-sm"
                />
              ) : (
                <div
                  className={cn(
                    'flex h-full w-full items-center justify-center rounded-full font-semibold text-white shadow-sm',
