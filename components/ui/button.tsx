...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative overflow-hidden',
  {
    variants: {
      variant: {
        ...
        primary: [
          ...
          'disabled:from-gray-400 disabled:to-gray-400 disabled:shadow-none disabled:scale-100 disabled:cursor-not-allowed',
        ...
        secondary: [
          ...
          'hover:bg-deep-teal/90 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200',
        ...
        outline: [
          ...
          'hover:bg-lumina-gold hover:text-white hover:shadow-md hover:scale-105 active:scale-95 transition-all duration-200',
          'focus-visible:ring-lumina-gold focus-visible:ring-2 focus-visible:ring-offset-2',
          'disabled:border-gray-400 disabled:text-gray-400 disabled:hover:bg-transparent disabled:hover:text-gray-400 disabled:scale-100 disabled:cursor-not-allowed',
          // High contrast mode support
        ...
        ghost: [
          ...
          'hover:bg-lumina-gold/10 hover:text-lumina-gold active:bg-lumina-gold/20 hover:scale-105 active:scale-95 transition-all duration-200',
          'focus-visible:ring-lumina-gold focus-visible:ring-2 focus-visible:ring-offset-2',
          'disabled:text-gray-400 disabled:hover:bg-transparent disabled:hover:text-gray-400 disabled:scale-100 disabled:cursor-not-allowed',
          // High contrast mode support
        ...
        destructive: [
          ...
          'hover:bg-red-700 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200',
        ...
        link: [
          ...
          'hover:underline hover:text-lumina-coral transition-colors duration-200',
