  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105 hover:shadow-md",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 bg-transparent border-foreground text-foreground hover:bg-foreground hover:text-background hover:shadow-lg",
        ...
        feature: "border-transparent bg-lumina-coral text-primary-foreground hover:bg-lumina-coral/80 hover:shadow-lumina-coral/25",
      },
    },
    defaultVariants: {
      variant: "default",
