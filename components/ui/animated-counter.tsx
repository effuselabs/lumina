...
const AnimatedCounter = React.forwardRef<HTMLDivElement, AnimatedCounterProps>(
    (
        ...
        const countUpOptions = React.useMemo(() => ({
            ...
            onComplete,
            preserveValue,
        }), [startValue, value, duration, decimals, prefix, suffix, separator, formatter, easing, onComplete, preserveValue]);
        ...
        }, [format, currencyCountUp, percentageCountUp, integerCountUp, customCountUp]);
        ...
        const progress = React.useMemo(() => {
            ...
            const currentNumericValue = parseFloat(counter.value.replace(/[^0-9.-]/g, ''));
            const range = value - startValue;
            const currentProgress = ((currentNumericValue - startValue) / range) * 100;
        ...
        const renderLabel = () => {
            ...
            return (
                <div className={cn(
                    'animated-counter-label text-muted-foreground font-medium',
        ...
        const renderProgress = () => {
            ...
            return (
                <div className="animated-counter-progress w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1 mt-2">
                    <div
                        className={cn(
