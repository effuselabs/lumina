...
export function AccessibleLayout({
    ...
    const layoutContent = (
        <div className={cn('accessible-layout', className)}>
            ...
            {header && (
                <header
                    className="accessible-layout__header"
                    role="banner"
                >
                    {header}
                </header>
            ...
            {footer && (
                <footer
                    className="accessible-layout__footer"
                    role="contentinfo"
                >
                    {footer}
                </footer>
    ...
    return (
        ...
        >
            {title && (
                <HeadingTag
                    id={headingId}
                    className="page-section__heading"
                >
                    {title}
                </HeadingTag>
            )}
...
export function AccessibleTable({
    ...
    return (
        <div className="accessible-table-wrapper">
            {summary && (
                <p className="accessible-table__summary sr-only">
                    {summary}
                </p>
            )}
            <table
...
export function AccessibleList({
    ...
    if (type === 'description') {
        return (
            <dl
                className={cn('accessible-list accessible-list--description', className)}
                aria-label={ariaLabel}
                role={role}
            >
                {children}
...
export function AccessibleListItem({
    ...
    if (term) {
        return (
            <>
                <dt className={cn('accessible-list__term', className)}>
                    {term}
                </dt>
                <dd className="accessible-list__description">
                    {children}
                </dd>
            </>
        );
