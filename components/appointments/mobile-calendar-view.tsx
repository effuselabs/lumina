...
export function MobileCalendarView({
  ...
  return (
    <div
      ...
      className="bg-color-background relative flex h-full flex-col"
    >
      {/* Gesture feedback indicator */}
      {gestureState.isSwiping && (
        <div className="absolute left-1/2 top-4 z-50 -translate-x-1/2 transform rounded-full bg-black/70 px-3 py-1 text-sm text-white">
