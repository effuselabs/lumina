...
export interface AppointmentNotesProps {
  ...
  onAddNote?: (
    note: Omit<AppointmentNote, 'id' | 'createdAt'>
  ) => Promise<void>;
  ...
  const [notes, setNotes] = useState<AppointmentNote[]>([
    {
      id: '1',
      content:
        'Client prefers shorter haircuts and is sensitive to heat styling.',
      isInternal: false,
    ...
    },
    {
      id: '2',
      content:
        'Client was 15 minutes late for last appointment. Consider confirming arrival time.',
      isInternal: true,
          ...
          {isEditingMainNotes ? (
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-3">
                ...
                <Button onClick={handleSaveMainNotes} disabled={isLoading}>
            ...
            <div>
              {appointment.notes ? (
                ...
                <p className="italic text-gray-500">No notes added yet.</p>
              )}
            </div>
          )}
        </CardContent>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-end space-x-2">
                              ...
                              <Button
                                ...
                                disabled={
                                  isLoading || !editingNoteContent.trim()
                                }
                              >
