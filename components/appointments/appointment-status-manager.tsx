...
export function AppointmentStatusManager({
  ...
  const statusTransitions: StatusTransition[] = [
    ...
    // From COMPLETED (limited transitions)
    {
      ...
      requiresReason: true,
      confirmationMessage:
        'This will reopen a completed appointment. Please provide a reason.',
    },
  ];
  ...
  const getAvailableTransitions = (): StatusTransition[] => {
    return statusTransitions.filter(
      transition => transition.from === appointment.status
    );
  };
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label htmlFor="reason">
                ...
                {pendingTransition.to.replace('_', ' ')}":
              </Label>
              <Textarea
                id="reason"
                value={reason}
            ...
            <div className="flex justify-end space-x-3">
              ...
              >
                {isLoading
                  ? 'Processing...'
                  : `Confirm ${pendingTransition.label}`}
              </Button>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3 pb-3">
              ...
              <div className="flex-1">
                ...
                {appointment.updatedBy && (
                  <p className="text-sm text-gray-500">
                    Updated by {appointment.updatedBy}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="py-4 text-center text-sm text-gray-500">
              Status history would be displayed here based on appointment status
              history records
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span
                className={
                  appointment.canEdit ? 'text-green-600' : 'text-red-600'
                }
              >
            ...
            <div className="flex justify-between">
              ...
              <span
                className={
                  appointment.canCancel ? 'text-green-600' : 'text-red-600'
                }
              >
            ...
            <div className="flex justify-between">
              ...
              <span
                className={
                  appointment.canReschedule ? 'text-green-600' : 'text-red-600'
                }
              >
            ...
            {appointment.isConflicted && (
              <Alert className="mt-3">
                <AlertTriangle className="h-4 w-4" />
                <AlertDescription>
                  This appointment has scheduling conflicts that need to be
                  resolved.
                </AlertDescription>
              </Alert>
            )}
