// Export all appointment-related components
...
export { AppointmentNotes } from './appointment-notes';
export { AppointmentStatusManager } from './appointment-status-manager';
