...
export function AppointmentForm({
    ...
    const {
        ...
        defaultValues: {
            date: appointment ? appointment.startTime.toISOString().split('T')[0] : '',
            startTime: appointment ? appointment.startTime.toTimeString().slice(0, 5) : '',
            endTime: appointment ? appointment.endTime.toTimeString().slice(0, 5) : '',
            staffId: appointment?.staffId || '',
            serviceIds: appointment?.services.map(s => s.id) || [],
            clientName: appointment ? `${appointment.client.firstName} ${appointment.client.lastName}` : '',
                    ...
                    {services.map((service) => (
                        <div
                            ...
                            className={cn(
                                ...
                                selectedServices.includes(service.id)
                                    ? 'border-lumina-coral bg-lumina-radiant/10'
