...
export function ConflictResolutionModal({
    ...
    const [selectedResolution, setSelectedResolution] = useState<ConflictResolution['resolution']>('manual');
     ...
     */
    const getFieldDisplay = (appointment: DashboardAppointment, field: keyof DashboardAppointment) => {
        const value = appointment[field];

        switch (field) {
            case 'startTime':
            case 'endTime':
                return value ? format(new Date(value as string), 'MMM d, yyyy h:mm a') : 'Not set';
            case 'totalPrice':
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span className="ml-2">
                                        {conflict.localVersion.client?.firstName} {conflict.localVersion.client?.lastName}
                                    </span>
                                </div>
                                <div>
                                    <span className="text-muted-foreground">Staff:</span>
                                    <span className="ml-2">{conflict.localVersion.staff?.displayName}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {isDeleteConflict ? (
                            ...
                            <div className="space-y-4">
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                    <h4 className="font-medium text-red-800 mb-2">Deletion Conflict</h4>
                                    <p className="text-sm text-red-700">
                                        This appointment was deleted on the server, but you have unsaved local changes.
                                    </p>
                                </div>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        {conflictingFields.map(field => (
                                            <div key={field} className="flex justify-between py-1">
                                                ...
                                                <span>{getFieldDisplay(conflict.localVersion, field)}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-medium text-blue-700">Your Version</span>
                                                        </div>
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-medium text-green-700">Server Version</span>
                                                        </div>
                                        ...
                                        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                                            ...
                                            {conflictingFields.map(field => (
                                                <div key={field} className="flex justify-between py-1">
                                                    ...
                                                    <span>{getFieldDisplay(conflict.mergedData!, field)}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
