...
import { formatCurrency, formatPercentage } from '@/lib/employment/calculations';
import {
...
interface EmploymentManagementProps {
    ...
    onUpdateEmployment: (staffId: string, config: EmploymentConfiguration) => Promise<void>;
    onTransitionEmployment: (staffId: string, transition: any, config: any) => Promise<void>;
    isLoading?: boolean;
    canEdit?: boolean;
}
...
export function EmploymentManagement({
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'configure' | 'preview'>('overview');
    ...
    const getEmploymentSummary = () => {
        ...
        if (staff.chairRentalAmount && staff.chairRentalPeriod) {
            summary.push(`${formatCurrency(staff.chairRentalAmount)} ${staff.chairRentalPeriod.toLowerCase()}`);
        }
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Manage {staff.displayName}'s employment type and compensation structure
                    </p>
                </div>
            ...
            {!staff.isActive && (
                <Alert>
                    ...
                    <AlertDescription>
                        This staff member is currently inactive. Employment configuration changes will take effect when they are reactivated.
                    </AlertDescription>
                </Alert>
            )}
