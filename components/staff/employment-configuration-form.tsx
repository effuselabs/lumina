...
import { CalendarIcon, DollarSignIcon, InfoIcon, PercentIcon } from 'lucide-react';
                ...
                <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                {Object.entries(employmentTypeDescriptions).map(([key, info]) => (
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                ...
                                                {selectedType === 'HYBRID' && ' (typically lower in hybrid model)'}
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            {/* Chair Rental Fields */}
                            {(selectedType === 'CHAIR_RENTAL' || selectedType === 'HYBRID') && (
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        {Object.entries(rentalPeriodDescriptions).map(([key, info]) => (
                                                            <SelectItem key={key} value={key}>
