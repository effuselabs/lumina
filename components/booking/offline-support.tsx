...
export function OfflineSupport({
  ...
  const { networkState, shouldShowOfflineMessage, resetRetryState } =
...
function OfflineModeWrapper({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className="sticky top-0 z-50 border-b border-yellow-200 bg-yellow-50 px-4 py-2">
...
function OfflineBookingInterface({
  data,
  onAddPendingAction,
}: OfflineBookingInterfaceProps) {
  ...
  const handleFormSubmit = (bookingData: any) => {
    ...
    alert(
      'Booking saved! It will be processed when you reconnect to the internet.'
    );
  };
