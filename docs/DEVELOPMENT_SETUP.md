...
2. Review the [Git Workflow Guide](./project-management/GIT_WORKFLOW.md) for branching strategy
3. Check the [Authentication Documentation](./features/authentication/AUTHENTICATION.md) for auth system details
